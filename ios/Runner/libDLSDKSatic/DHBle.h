...
- (void)readConfigCallBack:(DHBleResultType)result activeRSSI:(UInt16)level disConnectTime:(UInt16)disConnectTime txPower:(Byte)power activeTime:(UInt16)actTime config:(UInt8)config;
/**
 *  修改设备密码回调
 *
 *  @param result   执行结果返回状态
...
@property (nonatomic, weak)  id <DHBleDelegate> delegate;
...
-(DHBleErrorType)oneKeyConfigDevice:(CBPeripheral *)peripheral deviceNum:(NSString*)deviceId devicePassword:(NSString*)password activeRSSI:(UInt16)level disConnectTime:(UInt16)disConnectTime txPower:(Byte)power activeTime:(UInt16)actTime configBit:(UInt16)configBit;
...
//-(DHBleErrorType)oneKeyFlashAddKey:(CBPeripheral*)peripheral deviceNum:(NSString*) deviceId devicePassword:(NSString*) password type:(UInt8)keyType addKeyIdList:(NSArray*) keyIdList addStartDateList:(NSArray*)startDateList addActiveDateList:(NSArray*)activeDateList;
...
//门锁有效
-(DHBleErrorType)oneKeyRecoverDevice:(CBPeripheral *)peripheral deviceNum:(NSString*)deviceId;
//门锁有效
-(DHBleErrorType)oneKeyResetDevice:(CBPeripheral *)peripheral deviceNum:(NSString*)deviceId devicePassword:(NSString*)password;

-(DHBleErrorType)oneKeyConfigDeviceIdAndUnit:(CBPeripheral *)peripheral deviceNum:(NSString*)deviceId devicePassword:(NSString*)password unitId:(UInt32)unitId buildingCode:(UInt8)buildingCode newDeviceId:(NSString*) newDeviceIdStr readerId:(UInt8)readerId selector:(UInt8)selector;

-(DHBleErrorType)oneKeyReadDeviceUnit:(CBPeripheral *)peripheral deviceNum:(NSString*)deviceId devicePassword:(NSString*)password;
-(DHBleErrorType)oneKeyReadCommunityUnit:(CBPeripheral *)peripheral deviceNum:(NSString*)deviceId devicePassword:(NSString*)password buildingIndex:(UInt32)buildingIndex;

-(DHBleErrorType)oneKeyConfigCommunityUnit:(CBPeripheral *)peripheral deviceNum:(NSString*)deviceId devicePassword:(NSString*)password buildingIdList:(NSArray*) buildingIdList;


-(DHBleErrorType)oneKeyDelCommunityUnit:(CBPeripheral *)peripheral deviceNum:(NSString*)deviceId devicePassword:(NSString*)password delMask:(UInt8)delMask buildingId:(UInt8)buildingId;

-(DHBleErrorType)oneKeyReadLockRecord:(CBPeripheral *)peripheral deviceNum:(NSString*)deviceId devicePassword:(NSString*)password recordIndex:(UInt32)recordIndex;


-(DHBleErrorType)oneKeyDelLockRecord:(CBPeripheral *)peripheral deviceNum:(NSString*)deviceId devicePassword:(NSString*)password delMask:(UInt8)delMask;
// for one key end
...
-(NSString*)generateVisitCodeWithIds:(NSString*) deviceId
                           devicePsw:(NSString*)devicePsw validDate:(NSDate*)validDate communityCode:(UInt32)communityCode buildingCode:(UInt32)buildingCode visitIndex:(UInt32)visitIndex pswType:(UInt32)pswType softVersion:(UInt32)softVersion;
...
-(NSString*)generateVisitCodeWithDate:(NSString*) deviceId
                            devicePsw:(NSString*)devicePsw communityCode:(UInt32)communityCode
                         buildingCode:(UInt32)buildingCode valideData:(NSDate*)validDate startTime:(NSDate*)startTime endTime:(NSDate*)endTime softVersion:(UInt32)softVersion;
...
-(NSString*)generateVisiteCode:(UInt32)deviceId devicePassword:(UInt32)password startDate:(NSDate*) startDate activeTime:(UInt16)activeTime softVersion:(UInt16)softVersion;
//公寓7位入住码
