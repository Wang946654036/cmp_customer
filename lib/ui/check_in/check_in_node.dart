...
import 'check_in_operation_step.dart';

//流程节点
class CheckInCardNodeWidget extends StatefulWidget {
  String title; //标题
  String customerType;//客户类型
  List<RecordList> nodes; //流程节点
  CheckInCardNodeWidget(this.nodes, {this.title = label_apply_deal_progress,this.customerType});
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _CheckInCardNode();
  }
}

class _CheckInCardNode extends State<CheckInCardNodeWidget> {
                            ...
                            children: <Widget>[
                              ...
                              Visibility(
                                visible: widget.nodes[position].operateStep ==
                                        check_in_step_audit ,
//                                child: CommonText.text13(getCheckInStepContent(
