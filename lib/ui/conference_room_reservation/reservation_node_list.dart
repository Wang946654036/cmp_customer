...
class ReservationNodeListView extends StatefulWidget {
  List<RecordList> recordList;

  ReservationNodeListView(this.recordList);
...
class _NodeListViewState extends State<ReservationNodeListView> {
